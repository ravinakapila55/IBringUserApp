...
import com.iBring_user.app.Adapter.ServiceListAdapter;
...
import com.iBring_user.app.Utils.ClanProTextView;
                ...
                if (response != null && response.data != null) {
                    try {
                        ...
                        if (response.statusCode == 400 || response.statusCode == 405 ||
                                response.statusCode == 500 || response.statusCode == 422 || response.statusCode == 503)
                        {
                            retryforGetService();
    ...
    private void checkStatus() {
        try {
            ...
            if (helper.isConnectingToInternet()) {
                ...
                final JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, URLHelper.REQUEST_STATUS_CHECK_API,
                        new JSONObject(), new com.android.volley.Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
