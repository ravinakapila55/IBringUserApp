...
public class ForgetPassword extends AppCompatActivity {
    ...
    private void forgetPassword() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                URLHelper.FORGET_PASSWORD, object, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.e("ResponseForgetPswd ",""+response.toString());
                customDialog.dismiss();
                if (response.optString("message").equalsIgnoreCase("OTP sent to your email!"))
                {
...
//                finish();
        ...
        }, new Response.ErrorListener()
        {
            ...
            {
                Log.e("ResponseForgetError ",""+error.getMessage());
                customDialog.dismiss();
                String json = null;
                String Message;
