...
//        titleTxt.setText(getString(R.string.app_name) +" "+ getString(R.string.help));
    ...
    public void getHelp() {
        ...
        /*{"contact_number":"+971501265606",
        "contact_email":"director@ibring.co",
        "contact_text":"We are here to help and answer any questions you might have. We look forward to hearing from you.",
        "contact_title":"I Bring Services"}*/
