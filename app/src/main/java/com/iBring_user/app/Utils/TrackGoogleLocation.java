...
public class TrackGoogleLocation
{
    ...
    private  class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>>
    {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result)
        {
            ...
            for (int i = 0; i < result.size(); i++)
            {
                ...
                lineOptions.width(7);
                lineOptions.color(R.color.dark_gray);
    ...
    public void getEstimate(final LatLng latlngPick, final LatLng latlngDrop)
    {
        ...
        GoogleDirection.withServerKey(URLHelper.PLACES_API)
                .from(latlngPick)
                        ...
                        if (direction.isOK())
                        {
                            ...
                            if (value==14)
                            {
                                mMap.addPolyline(DirectionConverter.createPolyline(context, directionPositionList,
                                        3, context.getResources().getColor(R.color.dark_blue)));
                            }

                            else if (value==16)
                            {
                                mMap.addPolyline(DirectionConverter.createPolyline(context, directionPositionList,
                                        7, context.getResources().getColor(R.color.dark_blue)));
                            }
